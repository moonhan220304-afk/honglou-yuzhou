...
import { IconFlame, IconUser, IconPlus } from "@/components/icons";
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 md:px-6">
      <SectionHero
        ...
        eyebrow="QUESTIONS"
        title="问一问"
        description="每一个问题都不止一个答案。看看大家为哪些问题争得热闹——你的判断，才是最终的答案。"
        actions={
          <Link
            href={`${base}/questions/ask`}
            className="flex items-center gap-1.5 rounded-full bg-primary px-5 py-2.5 font-serif text-sm text-white shadow-sm transition-colors hover:bg-primary-deep"
          >
