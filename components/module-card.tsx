...
export default function ModuleCard({ title, subtitle, href, glyph }: ModuleCardProps) {
  return (
    <Link
      href={href}
      className="group relative overflow-hidden rounded-3xl bg-surface-warm card-print card-print--identity p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-hover"
    >
